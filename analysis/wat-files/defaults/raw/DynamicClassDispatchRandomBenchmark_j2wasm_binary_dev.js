// GENERATED CODE.
goog.module("DynamicClassDispatchRandomBenchmark_j2wasm_binary_dev.j2wasm");
...
function getImports() {
 return {
  ...
  'imports': {
   ...
   'set goog.global.__benchmarking_result': (/** ? */ value, ) => goog.global.__benchmarking_result = value,
...
async function instantiateStreaming(urlOrResponse) {
  const useMagicStringImports = false;
